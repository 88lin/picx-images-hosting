                        ...
                        for (var i = 0; i < this.packages.length; i++) {
                            ...
                            for (var _i = 0; _i < opackage.length; _i++) { // 遍历当前表情包中的所有表情
                                if (this.odata[this.packages[i]].type === 'image-zl') { // 如果当前表情包的类型是 'image'
                                    ...
                                    html += '\n <li class="OwO-item" title="' + opackage[_i].text + '" data-input="' + opackage[_i].text + '">' + '<img data-original="' + 'https://gcore.jsdelivr.net/gh/btwoa/Fluent-Emoji-3D/' + opackage[_i].text + '.gif" src="" icon="' + opackage[_i].text + '" referrerpolicy="no-referrer"></li>';
