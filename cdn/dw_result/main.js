const resultState = {
      ...
      function renderAnimalArchetype(animalName) {
        ...
        function workEnvText() {
          ...
          if ((score.DOM >= 75 && score.COM >= 60) || (score.COM >= 75 && score.DOM >= 60)) {
        ...
        function emotionText() {
          if (score.SEC >= 70) {
            ...
            if (score.COM >= 70) t += "高质量且稳定的人际互动，能够有效增强你的情感安全感。";
            else if (score.COM <= 30) t += "在独处中整理情绪、恢复秩序，是你应对不安的重要方式。";
            return t;
          }
          if (score.SEC <= 30) {
            let t = "你的情感模式更偏向内部自洽。你不太依赖外部持续的情感支持来维持状态，对环境变化具备较强的适应力。这种情感独立性让你在波动中能保持自主节奏。";
            if (score.COM >= 70) t += "即便如此，你依然重视真诚且无需过度消耗的深度关系。";
            else if (score.COM <= 30) t += "独处往往是你获得情感恢复与内在能量的主要来源。";
            return t;
          }
          if (score.COM >= 70) {
